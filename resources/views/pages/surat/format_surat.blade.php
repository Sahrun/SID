    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Format Surat</h4>
                                                    ...
                                                    <tr role="row" class="{{$no%2?'odd':'even'}}">
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                    <a href="{{url('surat/download/'.$item['template'])}}" target="_blank" class="btn btn-link btn-success btn-sm" title="Download" >
                                                                        <i class="fa fa-download"></i>
                                                                    </a>
                                                                    <a class="btn btn-link btn-warning btn-sm"
                                                                       title="Upload" 
                                                                       onclick="open_form('{{$item['kode']}}','{{$item['title']}}')">
