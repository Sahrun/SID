        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form role="form" method="post"  action="{{url('kependudukan/pendatang/create')}}" onsubmit="return Submit(this)" >
                            @csrf
                            <div class="form-group form-inline">
								<label class="col-md-3 label-control"><b>NIK</b></label>
								<div class="col-md-9 p-0">
									<input type="text" class="form-control input-full" name="nik" placeholder="NIK" required placeholder="NIK" minlength="16" maxlength="16" id="nik">
                            ...
                            <div class="form-group form-inline">
								...
								<div class="col-md-9 p-0">
									<input type="date" class="form-control" name="tanggal_lahir" placeholder="Tanggal lahir" id="tanggal_lahir"  required onchange="validasitanggal()">
