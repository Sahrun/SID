                                                    ...
                                                    <tr role="row" class="{{$no%2?'odd':'even'}}">
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                ...
                                                                <a href="{{url('kependudukan/keluarga/view/'.$item->keluarga_id)}}" class="btn btn-link btn-primary btn-lg" title="Show">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                                <a title="Delete" class="btn btn-link btn-danger"  onclick="return confirm('Anda akan menghapus?')" href="{{url('kependudukan/keluarga/delete/'.$item->keluarga_id)}}">
