...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2019 at 01:13 PM
...
(8, '423434343', NULL, 79, 85, 80, 4, 'Rindu', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2019-12-15 03:20:59', '2019-12-15 03:29:09', 'ISTRI');
...
ALTER TABLE `kelahiran`
  ...
  ADD KEY `kelahiran_keluarga_id_foreign` (`keluarga_id`);
...
--
ALTER TABLE `kelahiran`
  MODIFY `kelahiran_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `kematian`
  MODIFY `kematian_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `penduduk`
  MODIFY `penduduk_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `kelahiran`
  ADD CONSTRAINT `kelahiran_keluarga_id_foreign` FOREIGN KEY (`keluarga_id`) REFERENCES `keluarga` (`keluarga_id`);
